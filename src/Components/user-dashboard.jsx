    ...
    <>
      <div className="text-white m-2 p-2 rounded-2">
        <div className="d-flex justify-content-evenly">
            <span className="animate__animated animate__fadeInLeft text-dark fw-bold fs-4">Welcome {Cookies["username"]} </span>{" "}
      ...
      <div className="d-flex justify-content-center row border border-dark m-4 m-md-3 rounded p-3">
        ...
        <div className="col-12 col-md-6 col-lg-3">
          ...
          <div className="row m-3 p-2 mb-3 animate__animated animate__fadeInLeft">
            {
              videos.map(video => 
                <div className="col-md-4 mb-4" key={video.VideoId}>
                  <div className="card h-100 shadow-lg">
                    <div className="card-body">
                      ...
                      <p className="mt-3 card-text overflow-auto" style={{maxHeight: "100px"}}>{video.Description}</p>
                    </div>
                    <div className="mt-auto card-footer bg-light">
                      <div className="d-flex justify-content-evenly">
                        <span onChange={(e)=>handleCountChange(e.target.value)} className="bi bi-eye-fill">
                          {handleCountChange(video.Views)}</span>
                          
                        <span className="bi bi-hand-thumbs-up-fill">{handleCountChange(video.Likes)}</span>
                        <span className="bi bi-hand-thumbs-down-fill">{handleCountChange(video.Dislikes)}</span>
                        <Button variant="contained" color="warning">Watch Later</Button>
                      </div>
                    </div>
                  </div>
                </div>
